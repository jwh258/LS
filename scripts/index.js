...
//function pre(kn) {
//	var obj = $(".newCard-ul ul").eq(kn);
//	var len = $(".newCard-ul ul").eq(kn).find("li").length;
//	var ltt = len - 5;
//	var li = obj.find("li").filter(":gt(" + ltt + ")");
//	li.remove();
//	li.prependTo(obj);
//	var obj2 = $(".newCard-ul").eq(kn).find("li:lt(5)");
//	replace_lz(obj2);
//}
//function next(kn) {
//	var obj = $(".newCard-ul ul").eq(kn);
//	var li = obj.find("li:lt(5)");
//	li.remove();
//	li.appendTo(obj);
//	var obj2 = $(".newCard-ul").eq(kn).find("li:lt(5)");
//	replace_lz(obj2);
